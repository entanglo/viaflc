...
export const MERGE_MINING_COINS = [
  ...
  { code: 'DOGE', icon: '/img/doge.png', active: false, mergeProgress: 0.5 },
  { code: 'PEP', icon: '/img/pep.png', active: false , mergeProgress: 0.4},
  { code: 'JKC', icon: '/img/jkc.png', active: false },
  { code: 'SHIC', icon: '/img/shic.png', active: false, mergeProgress: 0.3 },
  { code: 'LKY', icon: '/img/lky.png', active: false, mergeProgress: 0.8 },
  ...
  { code: 'CRC', icon: '/img/crc.png', active: false, mergeProgress: 0.1 }
];
